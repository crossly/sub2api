...
} from "./settings/openaiOverLimitFields";
import {
  applyOpenAIOverLimitSettingsToForm,
  useOpenAIOverLimitSettings,
} from "./settings/useOpenAIOverLimitSettings";
...
function updateOpenAIOverLimitField(
  ...
  if (key === "openai_over_limit_mode_enabled") {
    form.openai_over_limit_mode_enabled = Boolean(value);
    return;
  }

  form.openai_over_limit_cooldown_seconds = Number(value);
}
