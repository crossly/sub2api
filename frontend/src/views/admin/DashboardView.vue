    ...
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-fuchsia-100 p-2 dark:bg-fuchsia-900/30">
                <Icon name="chart" size="md" class="text-fuchsia-600 dark:text-fuchsia-300" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-lg bg-violet-100 p-2 dark:bg-violet-900/30">
                <Icon name="userPlus" size="md" class="text-violet-600 dark:text-violet-300" :stroke-width="2" />
              </div>
              <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                  {{ t('admin.dashboard.users') }}
                </p>
                <p class="text-xl font-bold text-violet-600 dark:text-violet-300">
